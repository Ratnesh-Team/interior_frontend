...
const MinutesOfMeeting = () => {
  ...
  return (
    <div className="container mx-auto p-4 bg-slate-100  relative  ">
      <div className=" bg-white p-6 rounded shadow-lg mt-2 rounded-lg">
        <h1 className="text-3xl font-bold mb-4 ">Minutes of Meeting</h1>
        <FontAwesomeIcon
          icon={faBell}
          className="text-xl absolute top-12  right-14"
        />
      </div>
